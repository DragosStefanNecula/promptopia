    ...
    return (
        <section className="w-full max-w-full flex-start flex-col">
            ...
            <form onSubmit={handleSubmit} className="mt-10 w-full max-w-2xl flex flex-col gap-7 glassmorphism">
                <label>
                    <span className="font-satoshi font-semibold text-base text-gray700">Your AI Prompt.</span>
                ...
                <label>
                    <span className="font-satoshi font-semibold text-base text-gray700">Tag {''}
